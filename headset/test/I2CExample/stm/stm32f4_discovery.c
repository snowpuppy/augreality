...
/** @defgroup STM32F4_DISCOVERY_LOW_LEVEL_Private_Variables
  * @{
  */ 
static GPIO_TypeDef * const GPIO_PORT[LEDn] = {LED4_GPIO_PORT, LED3_GPIO_PORT, LED5_GPIO_PORT,
                                 LED6_GPIO_PORT};
...
static GPIO_TypeDef * const BUTTON_PORT[BUTTONn] = {USER_BUTTON_GPIO_PORT }; 

static const uint16_t BUTTON_PIN[BUTTONn] = {USER_BUTTON_PIN }; 

static const uint32_t BUTTON_CLK[BUTTONn] = {USER_BUTTON_GPIO_CLK };

static const uint16_t BUTTON_EXTI_LINE[BUTTONn] = {USER_BUTTON_EXTI_LINE };

static const uint8_t BUTTON_PORT_SOURCE[BUTTONn] = {USER_BUTTON_EXTI_PORT_SOURCE};
								 
static const uint8_t BUTTON_PIN_SOURCE[BUTTONn] = {USER_BUTTON_EXTI_PIN_SOURCE }; 
